...
namespace LinearBeats.EditorTests.Time
{
    ...
    public class SampleTests
    {
        ...
        public void Implements_IComparable()
        {
            ...
            Iterate((f, v) =>
            {
                var vx = new Sample(f); // [-5_000 ~ 5_000]
                AssertEquatable(v, vx);

                var vn = new Sample(f - 5_000f); // [-10_000, 0]
                var vp = new Sample(f + 5_000f); // [0, 10_000]
        ...
        public void Calculable()
        {
            ...
            static bool Similar(Sample left, Sample right) => Math.Abs(left - right) < Delta;
        }
    }
}
